library(readxl)
library(tidyverse)
path = "C:/Users/huang/Downloads/2020總統-各投票所得票明細及概況/2020總統大選"
...
for (f in 1:length(files)){
  ...
  county = substr(tmp_line,16,18)
  print(county)
  print(f)
  tmp_data = read_excel(tmp_file,sheet = 1,skip =5 )
  colnames(tmp_data)[c(1:6)] = c("city","village","PFP vote","KMT vote","DDP vote","valid vote")
