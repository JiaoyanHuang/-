library(readxl)
library(tidyverse)
path = "C:/Users/huang/Downloads/2012立委/2012立法委員選舉得票概況"
...
for (f in 1:length(files)){
  ...
  tmp_data = tmp_data[,c(1,2,KMT_tmp_n,DDP_tmp_n,15)]
...
outfile = "C:/Users/huang/Desktop/台灣總統大選數據/2012_TW_政黨票_election.csv"
